...
if (isset($_POST["tambah"])) {
  ...
  $sql_insert = "INSERT INTO rekapitulasi VALUES('$kode', '$id_user', '$id_kategori', '$keterangan', 'masuk', '$jumlah', '$tanggal') ";
...
$sql = "SELECT rekapitulasi.*, users.username, kategori.nama_kategori FROM rekapitulasi JOIN users ON rekapitulasi.id_user=users.id JOIN kategori ON rekapitulasi.id_kategori=kategori.id_kategori  WHERE jenis='masuk' ORDER BY tanggal DESC";
...
$result_total = mysqli_query($conDB, "SELECT SUM(jumlah) as jmlh FROM rekapitulasi WHERE jenis = 'masuk' ");
$data_masuk = mysqli_fetch_assoc($result_total);
$total_masuk = $data_masuk["jmlh"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex justify-content-center">
                          ...
                          <a href="<?= base_url('/masuk.php?id_hps='); ?><?= $dt['kode']; ?>" class="btn d-flex btn-danger pl-2 pr-2 btn-hapus">
        ...
        <div class="modal fade" id="modalPrint" tabindex="-1" aria-labelledby="printLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- form -->
                <form action="<?= base_url('/print_periode.php?type=masuk'); ?>" method="post">
                  <div class="form-group">
                    <label for="tgl_mulai">
                      Dari Tanggal
                    </label>
                  ...
                  <div class="mt-2">
                    ...
                    <a href="<?= base_url('/print_all.php?type=masuk'); ?>" target="_blank" class="btn btn-primary float-right mr-2">
                      <i class="fas fa-print mr-1"></i>
                      Cetak Semua
                    </a>
                  </div>
