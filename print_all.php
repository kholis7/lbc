...
// ambil data
$sql = "SELECT rekapitulasi.*, users.username, kategori.nama_kategori FROM rekapitulasi JOIN users ON rekapitulasi.id_user = users.id JOIN kategori ON rekapitulasi.id_kategori=kategori.id_kategori WHERE jenis = '$type' ";
...
// ambil jumalh 
$sql_jumlah = "SELECT SUM(jumlah) AS jmlh FROM rekapitulasi WHERE jenis = '$type' ";
